...
extern "C" __global__ __aicore__ void interpolate_unified_bf16(
    GM_ADDR x, GM_ADDR h_idx, GM_ADDR w_idx, GM_ADDR h_w, GM_ADDR w_w,
    GM_ADDR y, GM_ADDR tiling)
{
    AscendC::TPipe pipe;
    InterpolateUnifiedKernel<bfloat16_t> kernel;
...
{
    interpolate_unified_bf16<<<blockDim, nullptr, stream>>>(
