...
# Test file: /home/z00841464/benchmark/Triton_Automation-br_a3_operator/ascend/test/vllm_operator_cases/newtest_cases/test_kernel_unified_attention_3d.py
# Main kernel: kernel_unified_attention_3d
# PT file: kernel_unified_attention_3d_test_data_fixed_v2.pt
...
def kernel_unified_attention_3d(
    ...
    Q = tl.load(
        query_ptr + query_offset.to(tl.int32),
    ...
    tl.store(
        segm_output_ptr + segm_output_offset.to(tl.int32),
        acc,
        mask=dim_mask[None, :] & query_mask_0[:, None] & query_mask_1[:, None],
    )
    segm_offset = (
    ...
    tl.store(segm_max_ptr + segm_offset.to(tl.int32), M, mask=query_mask_0 & query_mask_1)
    tl.store(segm_expsum_ptr + segm_offset.to(tl.int32), L, mask=query_mask_0 & query_mask_1)
