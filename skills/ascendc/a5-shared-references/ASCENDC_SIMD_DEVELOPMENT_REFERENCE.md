...
Always validate against PyTorch spec (OL-28), not CUDA. The A3 implementation's precision bug was not caught because it was only compared against CUDA (which also has different behavior).
...
- **This file**: `src/skills/references/ASCENDC_SIMD_DEVELOPMENT_REFERENCE.md`
